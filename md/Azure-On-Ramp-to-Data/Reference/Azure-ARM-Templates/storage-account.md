...
Resource File: [storage-account.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\templates/storage-account.json + )

Metadata File: [storage-account.metadata.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\templates/storage-account.metadata.json + )

Test Parameters File: [storage-account.test.parameter.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\templates/storage-account.test.parameter.json + )
...
AccessTier     | string | This setting is reORG-TAGred if using Blob Storage as the storageKind, otherwise can be left blank | Hot
