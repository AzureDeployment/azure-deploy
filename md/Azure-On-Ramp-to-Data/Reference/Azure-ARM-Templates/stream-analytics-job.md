...
Resource File: [stream-analytics-job.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\templates/stream-analytics-job.json + )

Metadata File: [stream-analytics-job.metadata.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\templates/stream-analytics-job.metadata.json + )

Test Parameters File: [stream-analytics-job.test.parameter.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\templates/stream-analytics-job.test.parameter.json + )
...
streamAnalyticsName | string | The name of the Stream Analytics Job. | asaj-ORG-TAG-adap-dev-eus-01
