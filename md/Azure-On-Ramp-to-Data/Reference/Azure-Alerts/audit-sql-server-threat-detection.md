# Alert Definition: audit-sql-server-threat-detection
...
Resource File: [azuredeploy.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\sql\audit-sql-server-threat-detection/azuredeploy.json + )
...
Parameters File: [azuredeploy.parameter.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\sql\audit-sql-server-threat-detection/azuredeploy.parameters.json + )
