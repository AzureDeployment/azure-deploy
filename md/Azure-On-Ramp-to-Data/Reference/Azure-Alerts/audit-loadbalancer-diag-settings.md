# Alert Definition: audit-loadbalancer-diag-settings
...
Resource File: [azuredeploy.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\loadbalancer\audit-loadbalancer-diag-settings/azuredeploy.json + )
...
Parameters File: [azuredeploy.parameter.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\loadbalancer\audit-loadbalancer-diag-settings/azuredeploy.parameters.json + )
