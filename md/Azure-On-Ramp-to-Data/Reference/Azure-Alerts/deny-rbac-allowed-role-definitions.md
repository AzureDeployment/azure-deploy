# Alert Definition: deny-rbac-allowed-role-definitions
...
Resource File: [azuredeploy.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\rbac\deny-rbac-allowed-role-definitions/azuredeploy.json + )
...
Parameters File: [azuredeploy.parameter.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\rbac\deny-rbac-allowed-role-definitions/azuredeploy.parameters.json + )
