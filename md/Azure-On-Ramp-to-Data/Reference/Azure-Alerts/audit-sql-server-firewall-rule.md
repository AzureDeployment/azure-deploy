# Alert Definition: audit-sql-server-firewall-rule
...
Resource File: [azuredeploy.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\sql\audit-sql-server-firewall-rule/azuredeploy.json + )
...
Parameters File: [azuredeploy.parameter.json](C:\AzureDevOps\Repos\Quisitive\AzureCoE\azure-deployment-coe\code\infrastructure\scripts\ps\azure\arm\..\..\..\..\arm\alert\alerts\sql\audit-sql-server-firewall-rule/azuredeploy.parameters.json + )
